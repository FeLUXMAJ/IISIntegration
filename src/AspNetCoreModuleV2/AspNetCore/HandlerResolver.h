...
private:
    HRESULT LoadRequestHandlerAssembly(const IHttpApplication &pApplication, ShimOptions& pConfiguration, std::unique_ptr<ApplicationFactory>& pApplicationFactory);
